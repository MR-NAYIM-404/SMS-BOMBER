...
{acl}[ {ycl}4. {acl}] {gcl}FB PAGE
{acl}[ {ycl}5. {acl}] {gcl}FB GROUP
...
try:
  while True:
    ...
    if mao=="1":
      ...
      os.system('python smsbomber.py --smsbombing mail --mail {mail} --threat {threat}'.format(mail=mails,threat=threat))
      break
